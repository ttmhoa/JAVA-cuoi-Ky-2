    ...
    public void login() {
        ...
        try {
            if (username.getText().isEmpty() || password.getText().isEmpty()) {
                ...
                String hashedPassword = EncryptionUtils.hashPassword(password.getText());
        ...
        try {
            if (email.getText().isEmpty() || usernameplus.getText().isEmpty() || passwordplus.getText().isEmpty()) {
                ...
                if (passwordplus.getText().length() < 8) {
                    ...
                    String hashedPassword = EncryptionUtils.hashPassword(passwordplus.getText());
